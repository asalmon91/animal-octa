...
<Project Type="Project" LVVersion="17008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="a/c" Type="Folder">
			<Item Name="holdGalvos.vi" Type="VI" URL="../align-calibrate/holdGalvos.vi"/>
			<Item Name="line_spectrum.vi" Type="VI" URL="../align-calibrate/line_spectrum.vi"/>
		</Item>
		<Item Name="Classes" Type="Folder">
			<Item Name="Hardware" Type="Folder">
				<Item Name="Camera.lvclass" Type="LVClass" URL="../classes/HardwareObjects/Camera/Camera.lvclass"/>
				<Item Name="DAQ.lvclass" Type="LVClass" URL="../classes/HardwareObjects/DAQ/DAQ.lvclass"/>
				<Item Name="Galvonometer.lvclass" Type="LVClass" URL="../classes/HardwareObjects/Galvonometer/Galvonometer.lvclass"/>
				<Item Name="Light Source.lvclass" Type="LVClass" URL="../classes/HardwareObjects/LightSource/Light Source.lvclass"/>
				<Item Name="PC.lvclass" Type="LVClass" URL="../classes/HardwareObjects/PC/PC.lvclass"/>
				<Item Name="Spectrometer.lvclass" Type="LVClass" URL="../classes/HardwareObjects/Spectrometer/Spectrometer.lvclass"/>
			</Item>
			<Item Name="Scans" Type="Folder">
				<Item Name="Scan.lvclass" Type="LVClass" URL="../classes/Scans/Scan.lvclass"/>
			</Item>
			<Item Name="Software" Type="Folder">
				<Item Name="ConfigProc.lvclass" Type="LVClass" URL="../classes/SoftwareObjects/ConfigProc/ConfigProc.lvclass"/>
			</Item>
		</Item>
		<Item Name="fx" Type="Folder">
			<Item Name="camera" Type="Folder">
				<Item Name="bitDepthToBytes.vi" Type="VI" URL="../fx/bitDepthToBytes.vi"/>
				<Item Name="CloseCamera.vi" Type="VI" URL="../fx/CloseCamera.vi"/>
				<Item Name="closeImaqSession.vi" Type="VI" URL="../fx/closeImaqSession.vi"/>
				<Item Name="GrabFrame.vi" Type="VI" URL="../fx/GrabFrame.vi"/>
				<Item Name="InitCamera.vi" Type="VI" URL="../fx/InitCamera.vi"/>
				<Item Name="parse_camera_data_representation.vi" Type="VI" URL="../fx/ini/parse_camera_data_representation.vi"/>
				<Item Name="parse_camera_dimensions.vi" Type="VI" URL="../fx/ini/parse_camera_dimensions.vi"/>
			</Item>
			<Item Name="DAQ" Type="Folder">
				<Item Name="stopAllTasks.vi" Type="VI" URL="../fx/stopAllTasks.vi"/>
				<Item Name="SyncGalvosCamera.vi" Type="VI" URL="../fx/SyncGalvosCamera.vi"/>
			</Item>
			<Item Name="display" Type="Folder">
				<Item Name="flipAndAverageBidirectional.vi" Type="VI" URL="../fx/display/flipAndAverageBidirectional.vi"/>
			</Item>
			<Item Name="DLL" Type="Folder">
				<Item Name="createQueues.vi" Type="VI" URL="../fx/createQueues.vi"/>
				<Item Name="getDoppler_callDLL.vi" Type="VI" URL="../fx/getDoppler_callDLL.vi"/>
				<Item Name="getIFT_callDLL.vi" Type="VI" URL="../fx/getIFT_callDLL.vi"/>
				<Item Name="PreallocateArraysFFTW3.vi" Type="VI" URL="../fx/PreallocateArraysFFTW3.vi"/>
			</Item>
			<Item Name="ini" Type="Folder">
				<Item Name="LoadAdvancedSettings.vi" Type="VI" URL="../fx/LoadAdvancedSettings.vi"/>
				<Item Name="read_ini.vi" Type="VI" URL="../fx/ini/read_ini.vi"/>
				<Item Name="updateDefaultSettings.vi" Type="VI" URL="../fx/updateDefaultSettings.vi"/>
				<Item Name="write_ini.vi" Type="VI" URL="../fx/ini/write_ini.vi"/>
			</Item>
			<Item Name="output" Type="Folder">
				<Item Name="CreateFile.vi" Type="VI" URL="../fx/CreateFile.vi"/>
				<Item Name="scanObjToTxt.vi" Type="VI" URL="../fx/output/scanObjToTxt.vi"/>
				<Item Name="writeScanObj.vi" Type="VI" URL="../fx/output/writeScanObj.vi"/>
			</Item>
			<Item Name="proc" Type="Folder">
				<Item Name="calcBG.vi" Type="VI" URL="../fx/calcBG.vi"/>
				<Item Name="call_opt_DispComp_matlab.vi" Type="VI" URL="../fx/dispComp/call_opt_DispComp_matlab.vi"/>
			</Item>
			<Item Name="Scans" Type="Folder">
				<Item Name="cropInactive.vi" Type="VI" URL="../fx/cropInactive.vi"/>
				<Item Name="GetRaster.vi" Type="VI" URL="../fx/GetRaster.vi"/>
				<Item Name="insertReturnTrip.vi" Type="VI" URL="../fx/insertReturnTrip.vi"/>
				<Item Name="updateScanObj.vi" Type="VI" URL="../fx/updateScanObj.vi"/>
				<Item Name="ValidateScanInput.vi" Type="VI" URL="../fx/ValidateScanInput.vi"/>
			</Item>
			<Item Name="sync" Type="Folder">
				<Item Name="configTrigger.vi" Type="VI" URL="../fx/sync/configTrigger.vi"/>
				<Item Name="ConfigureGalvos.vi" Type="VI" URL="../fx/ConfigureGalvos.vi"/>
				<Item Name="getAllFrames.vi" Type="VI" URL="../fx/sync/getAllFrames.vi"/>
				<Item Name="startMaster.vi" Type="VI" URL="../fx/sync/startMaster.vi"/>
			</Item>
			<Item Name="wb" Type="Folder">
				<Item Name="upateWaitBar.vi" Type="VI" URL="../fx/wb/upateWaitBar.vi"/>
			</Item>
		</Item>
		<Item Name="getDispCompVec.vi" Type="VI" URL="../fx/proc/getDispCompVec.vi"/>
		<Item Name="InitCameraSeq.vi" Type="VI" URL="../fx/InitCameraSeq.vi"/>
		<Item Name="loadSpecCal.vi" Type="VI" URL="../fx/proc/loadSpecCal.vi"/>
		<Item Name="Main.vi" Type="VI" URL="../Main.vi"/>
		<Item Name="processAllFrames.vi" Type="VI" URL="../fx/output/processAllFrames.vi"/>
		<Item Name="processFrame.vi" Type="VI" URL="../fx/proc/processFrame.vi"/>
		<Item Name="setupDispCompOptimization.vi" Type="VI" URL="../fx/dispComp/setupDispCompOptimization.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="IMAQ Occurrence Config2.vi" Type="VI" URL="/&lt;vilib&gt;/vision/driver/imaqsignalio.llb/IMAQ Occurrence Config2.vi"/>
			...
			<Item Name="calcReturnTime.vi" Type="VI" URL="../fx/calcReturnTime.vi"/>
			<Item Name="CreateOctaFile.vi" Type="VI" URL="../fx/CreateOctaFile.vi"/>
			<Item Name="eucDist.vi" Type="VI" URL="../fx/sync/eucDist.vi"/>
			<Item Name="imaq.dll" Type="Document" URL="imaq.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="InitGalvo.vi" Type="VI" URL="../../../../Orig_OCT_Software/InitGalvo.vi"/>
			<Item Name="Linspace.vi" Type="VI" URL="../fx/Linspace.vi"/>
			...
			<Item Name="processOctaVolMatlab.vi" Type="VI" URL="../fx/output/processOctaVolMatlab.vi"/>
			<Item Name="rotateXY.vi" Type="VI" URL="../fx/rotateXY.vi"/>
			<Item Name="SD_OCT_DLL_Ver3.dll" Type="Document" URL="../C/SD_OCT_DLL_Ver3/x64/Release/SD_OCT_DLL_Ver3.dll"/>
			<Item Name="writeToBinary.vi" Type="VI" URL="../fx/writeToBinary.vi"/>
		</Item>
